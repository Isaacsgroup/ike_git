...
# creating the frames in the window
        self.main = Frame(window, width=1350, height=800, bg="lightgreen")
    ...
    def startpage(self):
        ...
        bg = PhotoImage(file="dogpaw.png")
        self.image = Label(self.main, image=bg)
        self.image.place(x=0,y=0)
        # labels for the window
        self.heading = Label(self.main, text="Inventory Tracker App", font=('Centaur 20 bold') ,fg='black',bg="blue",relief=SUNKEN)
        self.heading.place(x=100, y=20)


        # Product name

        self.name = Label(self.main, text="Product Name", font=('arial 12 bold'),bg="lightblue")
        self.name.place(x=10, y=110)

        # Batch number

        self.age = Label(self.main, text="Batch number", font=('arial 12 bold'),bg="lightblue")
        self.age.place(x=10, y=155)

        # quality radio button
        Label(self.main, text="Quality", font=('arial 12 bold'),bg="lightblue").place(x=0, y=210)
        a = Radiobutton(self.main, text="Used" ,padx=40,font="ariel 10 bold", variable=self.v, value=1,bg="lightblue").place(x=120, y=210)
        b = Radiobutton(self.main, text="Fairly Used", padx=40,font="ariel 10 bold", variable=self.v, value=2,bg="lightblue").place(x=220, y=210)
...
# text box for lables
        ...
        self.batch_ent = Entry(self.main, width=30)
        self.batch_ent.place(x=140, y=160)
...
# button to perform a command
        ...
        self.submit = Button(self.main, text="Add Inventory", font="aried 12 bold",width=15, height=2, bg='lightgreen',command=self.add_appointment)
...
#show log
       ...
       #  display the logs in our frame
        ...
        self.logs = Label(self.main, text="Goods\n Available", font=('arial 10 bold'), fg='black',bg="lightblue")
...
# funtion to call submit button
    ...
    def add_appointment(self):
        ...
        self.val2 = self.batch_ent.get()
        if self.v.get()==1:
            self.val3 = "Used"
        elif self.v.get()==2:
            self.val3 = "Fairly Used"
        else:
        ...
        if self.val1 == '' or self.val2 == '' or self.val3 == '' or self.val4 == '' or self.val5 == '':
          tkinter.messagebox.showinfo("Warning", "Please Fill Up All Boxes")
            ...
            conn.commit()
            tkinter.messagebox.showinfo("Success", "\n inventory for " + str(self.val1) + " has been created")
        self.main.destroy()
    ...
    def showdetails(self):
        ...
        count1=0
        count2=0
        clmnname=['Inventory no','Pro_name','Batch','Quality','location','contact no']
...
#buttons for update and delete
    ...
    def delete1(self):
        ...
        for self.row in self.res:
            ...
            self.phone = self.row[5]
        # creating the update form
        self.uname = Label(self.deleteframe, text="Product Name", font=('arial 14 bold'))
        self.uname.place(x=0, y=140)

        self.uage = Label(self.deleteframe, text="Batch Number", font=('arial 14 bold'))
        self.uage.place(x=0, y=180)

        self.ugender = Label(self.deleteframe, text="Quality", font=('arial 14 bold'))
        self.ugender.place(x=0, y=220)
